...
$url = $_GET['url'];
$statement = $pdo->prepare("SELECT * FROM tbl_services WHERE url = ? AND status = 1");
...
<head>
    <title>Cosmicenergies | <?= $ser_name; ?>| <?= $ser_meta_title; ?></title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="as_main_wrapper">
                ...
                <div class="row">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                        <div class="as_service_detail_inner" id="para-18">
                            <h1 class="as_heading" style="color:var(--primary-color)"><?= $ser_heading; ?></h1>
                            <p class="as_font14" style="color: var(--gray-color);  font-size:18px !important; text-align:justify !important;">
                                <?= $ser_description; ?>
                            </p> 
                    ...
                    <div class="offset-xxl-2 col-xxl-4 col-xl-6 col-lg-6 col-md-12">
                         <h1 class="as_heading" style="color:var(--primary-color); visibility:hidden"><?= $ser_name; ?>  </h1>
                        <div class="as_service_detail_inner">
                            <img src="./admin/uploads/services/<?= $ser_image; ?>" alt="<?= $ser_name; ?>" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="as_servicedetail_wrapper as_padderBottom80 as_padderTop80" style="background-color: var(--white2-color); display: <?= $content_2_status; ?>;">
            <div class="container">
                <div class="row">
                    <div class=" col-xxl-5 col-xl-6 col-lg-6 col-md-12">
                        <div class="as_service_detail_inner">
                             <h1 class="as_heading" style="visibility: hidden;"><?= $ser_heading_2; ?></h1>
                            <img src="./admin/uploads/services/<?= $ser_image_2; ?>" alt="<?= $ser_heading_2; ?>" class="img-responsive">
                    ...
                    <div class="offset-xxl-1 col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                        <div class="as_service_detail_inner" id="para-18">
                            ...
                            <h1 class="as_heading"><?= $ser_heading_2; ?></h1>
