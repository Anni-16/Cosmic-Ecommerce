...
if (isset($_POST['form1'])) {
    ...
    if (!empty($_FILES['ser_image']['name'])) {
        ...
        $final_name1 = 'servcies-' . time() . '.' . $ext1;
        move_uploaded_file($_FILES['ser_image']['tmp_name'], './uploads/services/' . $final_name1);
    }

    if (!empty($_FILES['ser_image_2']['name'])) {
        $ext2 = pathinfo($_FILES['ser_image_2']['name'], PATHINFO_EXTENSION);
        $final_name2 = 'servcies-2-' . time() . '.' . $ext2;
        move_uploaded_file($_FILES['ser_image_2']['tmp_name'], './uploads/services/' . $final_name2);
    }



    // Insert into database
    $statement = $pdo->prepare("INSERT INTO tbl_services (
        ser_name,
        ser_heading,
        ser_image,
        ser_description,
    ...
    $statement = $pdo->prepare("UPDATE tbl_services SET  url = ? WHERE id = ?");
    $statement->execute([ $slug_url, $ai_id]);

    $success_message = 'Services item added successfully.';
}
?>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">servcies Name <span>*</span></label>
                            <div class="col-sm-8">
                                <input type="text" name="ser_name" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Heading Name <span>*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="ser_heading_2" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="ser_description_2" class="form-control" cols="30" rows="10" id="editor3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-success" name="form1">Add Servcies</button>
                            </div>
                        </div>
