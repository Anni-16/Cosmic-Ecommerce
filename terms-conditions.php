...
// Fetch payment policy once
$statement = $pdo->prepare("SELECT heading, content FROM tbl_term_conditions WHERE id = 1");
$statement->execute();
...
<head>
    <title>Cosmicenergies | <?= $heading; ?> </title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/terms-page.css" />
</head>
...
<body>
    ...
    <script src="assets/js/jquery.min.js" type="dea942b4e5104683ffff5739-tDisclaimer.phpext/javascript"></script>
