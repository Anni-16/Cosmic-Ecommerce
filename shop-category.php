...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/shop-category-page.css" />
</head>
                                                ...
                                                <div class="as_product_box product-card-animation" style="height:480px;">
                                                    <div class="as_product_img product-img">
                                                        <a href="shop-detail.php?url=<?php echo $product['url']; ?>">
                                                            <img src="./admin/uploads/products/<?= ($product['a_photo']); ?>" style="width: 400px;" alt="<?= ($product['a_name']); ?>">
                                                        </a>
                                                    </div>
