...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/disclaimer-page.css" />
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <ul class="breadcrumb" style="color:white; background:var(--white2-color);">
                            ...
                            <li><a href="vaastu.php" style="color: var(--primary-color); font-size:18px;  ">&nbsp; <?= $heading; ?> </a></li> 
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-12">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <p style="color: var(--gray-color); white-space: pre-line; font-size:18px; justify-content:justify">
                                    <?= $content; ?>
                                </p>
                            </div>
                        </div>
