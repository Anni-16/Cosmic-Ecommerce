...
<div style="background:var(--secondary-color)" class="no-bottom-gap">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <p style="color: var(--primary-color); text-align: center; padding-top: 20px;">
                    © cosmicenergies 2025 | All Rights Reserved
                    <a href="" style="display: none;"> Astrology Website Design - </a>
                    <a href="https://www.firstpointwebdesign.com/" target="_blank">Website Design By - First Point Web Design</a>
                </p>
            </div>
        </div>
    </div>
